        ...
        <Modal.Body>
          {courtDetail && (
            <div className="court-detail-container">
              <table className="court-detail-table">
                <tbody>
                  <tr>
                    <th colSpan="2" className="section-header">Thông tin cơ bản</th>
                  </tr>
                  <tr>
                    <td><i className="fas fa-hashtag me-2"></i>ID Sân</td>
                    <td>{courtDetail.courtId}</td>
                  </tr>
                  <tr>
                    <td><i className="fas fa-signature me-2"></i>Tên sân</td>
                    <td>{courtDetail.courtName}</td>
                  </tr>
                  <tr>
                    <td><i className="fas fa-money-bill me-2"></i>Giá/Giờ</td>
                    <td className="price">{courtDetail.pricePerHour?.toLocaleString('vi-VN')} VNĐ</td>
                  </tr>
                  <tr>
                    <td><i className="fas fa-toggle-on me-2"></i>Trạng thái</td>
                    <td>
                      <span className={`status-badge ${courtDetail.statusName === 'Active' ? 'active' : 'inactive'}`}>
                  ...
                  <tr>
                    <th colSpan="2" className="section-header">Phân loại</th>
                  </tr>
                  <tr>
                    <td><i className="fas fa-th-large me-2"></i>Loại sân</td>
                    <td>{courtDetail.categoryName}</td>
                  </tr>
                  <tr>
                    <td><i className="fas fa-building me-2"></i>Thuộc cơ sở</td>
                    <td>{courtDetail.facilityName}</td>
                  </tr>
                  
                  <tr>
                    <th colSpan="2" className="section-header">Thông tin liên hệ</th>
                  </tr>
                  <tr>
                    <td><i className="fas fa-map-marker-alt me-2"></i>Địa chỉ</td>
                    <td>{courtDetail.location}</td>
                  </tr>
                  <tr>
                    <td><i className="fas fa-phone me-2"></i>Liên hệ</td>
                    <td>{courtDetail.contact}</td>
                  </tr>
                </tbody>
              </table>
            </div>
