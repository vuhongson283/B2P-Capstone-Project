...
const OwnerDashboard = () => {
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      // Tạo blob trực tiếp từ array buffer
      ...
      link.href = url;
      link.setAttribute('download', `bao_cao_${new Date().getTime()}.xlsx`);
      ...
      alert(`Xuất file Excel thất bại: ${error.message}`);
    } finally {
                ...
                <div key={booking.bookingId} className="booking-item">
                  <div className="booking-info">
                    ...
                    <div className="booking-details">
                      ...
                      <div>
                        <strong>Lượt book sân:</strong> {booking.timeSlotCount}
                      </div>
                      <div>
