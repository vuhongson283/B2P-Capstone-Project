        ...
        <Modal.Body className="detail-body">
          {courtDetail && (
            <div className="court-detail">
              <div className="detail-section">
                ...
                <div className="detail-grid">
                  <div className="detail-item">
                    <label><i className="fas fa-hashtag me-2"></i>ID Sân</label>
                    <span className="value">{courtDetail.courtId}</span>
                  </div>
                  <div className="detail-item">
                    <label><i className="fas fa-signature me-2"></i>Tên sân</label>
                    <span className="value">{courtDetail.courtName}</span>
                  </div>
                  <div className="detail-item">
                    <label><i className="fas fa-money-bill me-2"></i>Giá/Giờ</label>
                    <span className="value highlight">{courtDetail.pricePerHour?.toLocaleString('vi-VN')} VNĐ</span>
                  </div>
                  <div className="detail-item">
                    <label><i className="fas fa-toggle-on me-2"></i>Trạng thái</label>
              ...
              <div className="detail-section">
                <h5 className="section-title">Thông tin phân loại</h5>
                <div className="detail-grid">
                  <div className="detail-item">
                    <label><i className="fas fa-th-large me-2"></i>Loại sân</label>
                    <span className="value">{courtDetail.categoryName}</span>
                  </div>
                  <div className="detail-item">
                    <label><i className="fas fa-building me-2"></i>Thuộc cơ sở</label>
                    <span className="value">{courtDetail.facilityName}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="detail-section">
                ...
                <div className="detail-grid">
                  <div className="detail-item">
                    ...
                    <span className="value">{courtDetail.location}</span>
                  </div>
                  <div className="detail-item">
                    <label><i className="fas fa-phone me-2"></i>Số điện thoại</label>
                    <span className="value">{courtDetail.contact}</span>
                  </div>
                </div>
              </div>
            </div>
