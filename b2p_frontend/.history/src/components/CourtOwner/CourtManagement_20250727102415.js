      ...
      <Modal show={showDetailModal} onHide={() => setShowDetailModal(false)} size="lg">
        <Modal.Header closeButton className="detail-header">
          <Modal.Title>
            ...
            Chi tiết sân #{courtDetail?.courtId}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {courtDetail && (
            <div className="court-detail">
              ...
              <div className="detail-section pricing-info">
                <h5 className="section-title">
                  <i className="fas fa-dollar-sign me-2"></i>
                  Thông tin giá
                </h5>
                <div className="price-display">
                  <span className="price-amount">{courtDetail.pricePerHour?.toLocaleString('vi-VN')}</span>
                  <span className="price-unit">VNĐ/giờ</span>
                </div>
              </div>

              <div className="detail-section facility-info">
                <h5 className="section-title">
                ...
                <div className="detail-grid">
                  <div className="detail-item">
                    <label><i className="fas fa-building me-2"></i>Tên cơ sở</label>
                  ...
                  <div className="detail-item">
                    <label><i className="fas fa-phone me-2"></i>Liên hệ</label>
