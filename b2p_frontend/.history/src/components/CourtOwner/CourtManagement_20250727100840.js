  ...
  const handleViewDetail = async (courtId) => {
    try {
      ...
      if (response.data?.success) {
        setCourtDetail(response.data.data);
        ...
        <Modal.Body>
          {courtDetail ? (
            <div className="court-detail-container">
              <h5 className="mb-4">{courtDetail.courtName}</h5>
              
              <div className="detail-row">
                <span className="detail-label"><i className="fas fa-hashtag me-2"></i>ID Sân:</span>
                <span className="detail-value">{courtDetail.courtId}</span>
              </div>
              
              <div className="detail-row">
                <span className="detail-label"><i className="fas fa-th-large me-2"></i>Thể loại:</span>
                <span className="detail-value">{courtDetail.categoryName || 'Chưa phân loại'}</span>
              </div>
              
              <div className="detail-row">
                <span className="detail-label"><i className="fas fa-money-bill me-2"></i>Giá/Giờ:</span>
                <span className="detail-value">{formatPrice(courtDetail.pricePerHour)} VND</span>
              </div>
              
              <div className="detail-row">
                <span className="detail-label"><i className="fas fa-toggle-on me-2"></i>Trạng thái:</span>
              ...
              <div className="detail-actions mt-4">
                ...
                <Button 
                  variant="danger"
                  onClick={() => {
                    handleDeleteCourt(courtDetail.courtId);
                    setShowDetailModal(false);
                  }}
                >
