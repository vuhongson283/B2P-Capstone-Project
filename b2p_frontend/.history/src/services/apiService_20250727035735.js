...
const getReport = (userId=6, startDate, endDate, facilityId, pageNumber=1, pageSize=10)
=> {
  return axios.get(`Report/ReportList?userId=${userId}&facilityId=${userId}&pageNumber=${userId}&pageSize=${userId}`)
};
