...
const exportReportToExcel = (
  ...
  return axios.get(
    `Report/Export-Report-CourtOwner?userId=${userId}&startDate=${startDate}&endDate=${endDate}&facilityId=${facilityId}&pageNumber=${pageNumber}&pageSize=${pageSize}`,
    {
      responseType: 'blob', // Thay đổi từ arraybuffer sang blob
      headers: {
