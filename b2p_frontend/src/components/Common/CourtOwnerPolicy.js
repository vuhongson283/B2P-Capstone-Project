  ...
  const benefits = [
    {
      ...
      description:
        "Tăng doanh thu từ sân của bạn với hệ thống đặt online hiệu quả",
        ...
        <div className="container">
          <div className="hero-content animate-in" id="hero">
            ...
            <h1 className="hero-title">
              Trở Thành <span className="gradient-text">Đối Tác</span>
              <br />
              Chủ Sân
            </h1>

            <p className="hero-subtitle">
              Gia nhập mạng lưới sân thể thao hàng đầu và tận hưởng thu nhập ổn
              định với hàng ngàn khách hàng tiềm năng
            </p>
        ...
        <div className="container">
          <div className="cta-content animate-in" id="cta">
            ...
            <p className="cta-subtitle">
              Gia nhập ngay hôm nay để tăng doanh thu và tiếp cận hàng ngàn
